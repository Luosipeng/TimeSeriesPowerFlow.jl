"""
Update power flow solution with computed voltage values and calculate generator outputs and branch flows.
For the version with load data as a separate parameter.
"""
...
"""
Update power flow solution with computed voltage values and calculate generator outputs and branch flows.
Standard version without separate load data parameter.
"""
